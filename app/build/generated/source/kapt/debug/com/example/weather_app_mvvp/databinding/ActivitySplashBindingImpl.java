...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.imgSplash, 1);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vmodel == variableId) {
            setVmodel((com.example.weather_app_mvvp.app.ui.splash.SplashViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVmodel(@Nullable com.example.weather_app_mvvp.app.ui.splash.SplashViewModel Vmodel) {
        this.mVmodel = Vmodel;
    }
