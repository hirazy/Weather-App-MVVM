...
public class ActivityLauncherBindingImpl extends ActivityLauncherBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vmode == variableId) {
            setVmode((com.example.weather_app_mvvp.app.ui.launcher.LauncherViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVmode(@Nullable com.example.weather_app_mvvp.app.ui.launcher.LauncherViewModel Vmode) {
        this.mVmode = Vmode;
    }
