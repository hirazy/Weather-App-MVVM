...
public final class Main {
    ...
    public final com.example.weather_app_mvvp.app.model.entity.Main copy(double temp, double feels_like, double temp_min, double temp_max, int pressure, int humidity) {
        return null;
    }
